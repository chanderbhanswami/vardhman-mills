...
const socialPlatforms: SocialPlatform[] = [
  ...
  },
  {
    ...
    followers: '89K',
    color: 'text-pink-400',
    hoverColor: 'hover:bg-pink-900/20',
  ...
  },
  {
    ...
    followers: '32K',
    color: 'text-red-400',
    hoverColor: 'hover:bg-red-900/20',
...
const SocialLinks: React.FC<SocialLinksProps> = ({
          ...
          return (
            <Link
              ...
              className={`
                ...
                bg-gray-800 ${platform.color} ${platform.hoverColor}
  ...
  return (
    <div className={`${className}`}>
      ...
      {/* Call to Action */}
      <div className="mt-6 p-4 bg-blue-900/20 border border-blue-700 rounded-lg shadow-sm">
