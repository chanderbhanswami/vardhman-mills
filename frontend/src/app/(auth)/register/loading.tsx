/**
 * Register Page Loading Component - Vardhman Mills Frontend
 * 
 * Loading skeleton for the registration page with animated placeholders
 ...
 * 
 * Displays a loading skeleton that matches the registration form layout
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center">
                  <motion.div
                    animate={{ opacity: [0.6, 1, 0.6] }}
                    transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }}
                    className="px-4 h-4 bg-gray-200 rounded-full w-40"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <motion.div
                  ...
                  className="h-2 bg-gray-200 rounded-full w-full mt-2"
                />
              </div>
